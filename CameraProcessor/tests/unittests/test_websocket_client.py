...
class TestWebsocketClient:
    ...
    def setup_method(self):
        ...
        """
        self.message_object_start_tracking = json.loads('{"type": "start", "objectId": 1, "frameId": 1, "boxId": 1}')
        self.message_object_stop_tracking = json.loads('{"type": "stop", "objectId": 1}')
        self.message_object_update_feature_map = json.loads('{"type": "featureMap", "objectId": 1, "featureMap": []}')
        self.message_object_start_tracking_string = '{"type": "start", "objectId": 1, "frameId": 1, "boxId": 1}'
        self.message_object_stop_tracking_string = '{"type": "stop", "objectId": 1}'
        self.message_object_update_feature_map_string = '{"type": "featureMap", "objectId": 1, "featureMap": []}'
