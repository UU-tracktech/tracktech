...
__C.YOLO.CLASSES              = os.path.abspath(os.path.join(curr_dir, "data/classes/coco.names"))
...
__C.TRAIN.ANNOT_PATH          = os.path.abspath(os.path.join(curr_dir, "data/dataset/val2017.txt"))
