...
from detection.yolov4deepsort.core import utils as utils
from detection.yolov4deepsort.core.yolov4 import filter_boxes
# deep sort imports
from detection.yolov4deepsort.deep_sort import preprocessing, nn_matching
from detection.yolov4deepsort.deep_sort.detection import Detection
from detection.yolov4deepsort.deep_sort.tracker import Tracker
from detection.yolov4deepsort.tools import generate_detections as gdet
...
def detect_and_track(det_obj, trac_obj, tracker, loadedmodel):
    ...
    for track in tracker.tracks:
        ...
        det_obj.bounding_box.append(BoundingBox(track.track_id, bbox, class_name, None))
