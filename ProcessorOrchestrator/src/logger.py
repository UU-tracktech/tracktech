"""Logging component that contains log serving http handler, and a few util methods for logging.

This file contains an http request handler that server the log file generated by the program. The functions defined
can be used from other points in the program to easily create log entries formatted in a similar manner.
"""
