...
RUN ["npx", "typedoc", "--out", "docs/html/Interface", "Interface/react/src", "--tsconfig", "Interface/react/tsconfig.json", "--theme", "Interface/react/node_modules/typedoc-theme-dark/dist/dark/"]
